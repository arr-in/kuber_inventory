    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-[#00923F] hover:bg-[#007A35] text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-110 z-50"
